...
def equals():
    ...
    try:
        ...
        equation_label.set('Equation error')
...
button4 = Button(frame, text=5, height=4, width=9, font=35, command=lambda: button_press(5))
button4.grid(row=1, column=1)

button4 = Button(frame, text=6, height=4, width=9, font=35, command=lambda: button_press(6))
...
dec = Button(frame, text='.',height=4, width=9, font=35, command=lambda: button_press('.'))
dec.grid(row=3, column=3)
